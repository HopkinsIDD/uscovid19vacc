...
vacc_data <- get_clean_us_agevacc(git_token = "AB63TGGKM6VBDNGJHXRRP7LAYPDIM") %>% suppressMessages()

# Make it standardized to either 5yr or 10 year age groups
vacc_data_10yr <- get_standardized_us_agevacc(vacc_data = vacc_data,
                                        age_groups = "10yr", 
                                        git_token = "AB63TGGKM6VBDNGJHXRRP7LAYPDIM") %>% suppressMessages()
...
```vacc_data <- get_clean_us_agevacc(git_token = "AB63TGGKM6VBDNGJHXRRP7LAYPDIM")```
